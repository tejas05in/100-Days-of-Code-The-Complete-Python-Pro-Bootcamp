...
#     print(
#         f"Computer's final hand: {computer}, computer score: {sum(computer)}")

#     if sum(computer) == 21:
#         print("Computer wins")
#     elif sum(user) > 21:
#         print("Bust..you lose")
#     elif sum(user) == 21 or sum(user) > sum(computer) or sum(computer) > 21:
#         print("You win")
...
def calculate_score(cards: list):
    """returns the total score from the list of card values"""
...
def compare(user_score, computer_score):
    """compares user scores and computer scores and declares the results"""
...
def blackjack():
    """blackjack game function -> returns the final results"""
    print(logo)
    user_cards = []
    computer_cards = []
    is_game_over = False
